"""Sell 100% of Iran-surrender-Jun30 YES @ limit $0.75.

User's request 2026-04-17. Position 56 sh @ avg $0.27, cost $30. At bid
$0.75 fills immediately for ~+$27 profit.
"""
import sys, io, time
...
KEY_PREFIX = "0x34268ab1f5eb173b3603289606f7e963099185c9f4e743eb840db75da82e248e"
LIMIT_PRICE = 0.75
WATCH_SECONDS = 120
...
if final_matched > 0.5:
    ...
    tracker.record_sell(data, full_key, final_matched, LIMIT_PRICE, revenue,
                        "manual_100%_iran_surrender_jun30_limit75")
