"""Manual buy: $150 YES on Strait of Hormuz traffic returns to normal by end of April @ best ask."""
...
TOKEN = "77893140510362582253172593084218413010407941075415081594586195705930819989216"  # YES
...
if matched > 0.5:
    ...
    data.setdefault('positions', {})[new_key] = {
        ...
        "_adopted_from": "manual_buy_2026-04-20_hormuz_normal_apr30_150usd",
    }
    tracker.save(data)
