"""Buy $30 YES on Hormuz traffic returns to normal by April 30 @ $0.27 (= ask)."""
...
print(f"Live: bid ${bid:.3f}/ask ${ask:.3f}  limit ${LIMIT_PRICE}")
...
if matched > 0.5:
    ...
    data.setdefault('positions', {})[new_key] = {
        ...
        "_adopted_from": "manual_buy_2026-04-19_hormuz_topup30",
    }
    tracker.save(data)
