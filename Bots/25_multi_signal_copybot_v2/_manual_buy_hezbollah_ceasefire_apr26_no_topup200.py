"""Top-up: $200 NO on Israel x Hezbollah Ceasefire extended by April 26 @ limit $0.76."""
...
if matched > 0.5:
    ...
    if existing_key:
        ...
        data.setdefault('positions', {})[new_key] = {
            ...
            "_adopted_from": "manual_buy_2026-04-26_hezbollah_ceasefire_apr26_no_topup200",
        }
        tracker.save(data)
