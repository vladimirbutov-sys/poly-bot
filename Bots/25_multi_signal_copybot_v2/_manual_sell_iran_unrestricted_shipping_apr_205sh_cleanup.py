"""Cleanup: sell 205 sh YES on Iran unrestricted shipping Hormuz April.
Orphan position adopted via onchain_sync with signal_player='unknown' —
bot was blocked from following denizz's exit. See
_analytics/2026-04-21_unknown_signal_player_blocks_follow_sell.md
"""
import sys, io
...
TOKEN = "50460390339300670089294807389957154258823890126698777814350873553805417631623"  # YES
...
if matched > 0.5:
    ...
    p.setdefault("sells", []).append({
        ...
        "pnl": round(pnl, 4),
        "reason": "manual_cleanup_orphan_unknown_signal_player_bugfix",
