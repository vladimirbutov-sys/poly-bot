"""Top-up: $271 NO on Iran strike Qatar by April 30 @ limit $0.90 (sweep best 3 levels)."""
...
CID   = "0xe6a8bdcd0a55507e718303dbc04373821a35433b4a71de55ee759f10ee6be798"
TOKEN = "14450813207569853429427907799191506845125898776856365811166995747634801660417"  # NO
TITLE = "Will Iran strike Qatar by April 30, 2026?"
SLUG  = "will-iran-strike-qatar-by-april-30-2026"
EVENT_SLUG = "iran-military-action-against-by-april-30"
OUTCOME = "No"
SIZE_USD = 271.0
LIMIT_PRICE = 0.90  # sweep through 0.88, 0.89, 0.90 levels
...
if matched > 0.5:
    ...
    # Top-up onto existing manual position (find by CID/TOKEN)
    data = tracker.load()
    existing_key = None
    ...
    if existing_key:
        ...
        tracker.save(data)
        print(f"✓ Merged into {existing_key[:24]}: {old_sh:.2f}+{matched:.2f}={new_sh:.2f} sh, avg ${new_avg:.4f}, total cost ${new_cost:.2f}")
    else:
        # Fallback: create new position
        ...
        data.setdefault('positions', {})[new_key] = {
            ...
            "_adopted_from": "manual_buy_2026-04-25_iran_strike_qatar_apr30_no_topup271",
        }
        tracker.save(data)
        print(f"✓ Recorded new: {matched:.2f} sh @ ${actual_price:.4f} = ${actual_cost:.2f}")
else:
