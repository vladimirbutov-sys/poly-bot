"""Top-up: $200 NO on US x Iran diplomatic meeting by April 30, 2026 @ limit $0.76."""
...
OUTCOME = "No"
SIZE_USD = 200.0
LIMIT_PRICE = 0.76  # sweep best ask 0.75 + 0.76
...
if matched > 0.5:
    ...
    if existing_key:
        ...
        data.setdefault('positions', {})[new_key] = {
            ...
            "_adopted_from": "manual_buy_2026-04-25_us_iran_diplomatic_apr30_no_topup200",
        }
        tracker.save(data)
