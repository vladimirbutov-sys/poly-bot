"""Cancel $0.10 limit, place new buy @ $0.11 to cross ask."""
...
print(f"bid/ask: ${bid:.4f}/${ask:.4f}  new limit ${LIMIT_PRICE} (crosses ask)")
...
if matched > 0.5:
    ...
    data.setdefault('positions', {})[new_key] = {
        ...
        "_adopted_from": "manual_buy_2026-04-20_hormuz_under25_hedge_replace11",
    }
    tracker.save(data)
