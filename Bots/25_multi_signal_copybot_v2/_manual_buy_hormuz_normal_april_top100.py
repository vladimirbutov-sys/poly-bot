"""One-shot manual buy: Hormuz traffic returns to normal April 30 YES — $100.

Executed 2026-04-17 at user's explicit request, with full awareness that this
takes total position above MAX_POSITION_USD ($300). Bot's auto-rebuy is
already saturated; this is an intentional manual override.
"""
...
data.setdefault("positions", {})[new_key] = {
    ...
    "sells": [],
    "final_pnl": 0,
    "_adopted_from": "manual_buy_2026-04-17_top100",
}
tracker.save(data)
print(f"\n✓ Recorded as {new_key[:24]}...")
print(f"  shares: {matched:.2f}, cost: ${actual_cost:.2f}, entry: ${actual_price:.4f}")
print("  consolidate_duplicates will merge with existing 0xc230fd... position next cycle")
