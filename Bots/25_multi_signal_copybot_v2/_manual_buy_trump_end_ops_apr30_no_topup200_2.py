"""Top-up #2: $200 NO on Trump announces end of military operations against Iran by April 30 @ limit $0.96."""
...
OUTCOME = "No"
SIZE_USD = 200.0
LIMIT_PRICE = 0.96  # sweep best 2 levels (0.958 + 0.959)
...
if matched > 0.5:
    ...
    if existing_key:
        ...
        tracker.save(data)
        print(f"OK Merged: {old_sh:.2f}+{matched:.2f}={new_sh:.2f} sh, avg ${new_avg:.4f}, total cost ${new_cost:.2f}")
    else:
        ...
        data.setdefault('positions', {})[new_key] = {
            ...
            "_adopted_from": "manual_buy_2026-04-26_trump_end_ops_apr30_no_topup200_2",
        }
        tracker.save(data)
