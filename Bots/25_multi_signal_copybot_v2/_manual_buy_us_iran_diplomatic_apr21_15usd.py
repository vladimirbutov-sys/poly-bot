"""Buy $15 YES on US x Iran diplomatic meeting by April 21, 2026 @ ask $0.56."""
...
if matched > 0.5:
    ...
    data = tracker.load()
    # Check if existing YES position — top-up; else create new
    found_key = None
    ...
    if found_key:
        ...
        data.setdefault('positions', {})[new_key] = {
            ...
            "_adopted_from": "manual_buy_2026-04-20_us_iran_diplomatic_apr21_15usd",
        }
        tracker.save(data)
