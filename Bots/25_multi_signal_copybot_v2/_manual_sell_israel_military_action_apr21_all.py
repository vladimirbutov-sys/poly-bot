"""Manual sell: 100% YES on Will Israel conduct military action against Iran by April 21 @ best bid."""
import sys, io
...
TOKEN = "69918305790707613956950983542932789139135850481457755083498968292192269931106"  # YES
...
# Use bid directly (undercut less since prices are tiny and tick may be $0.001)
LIMIT_PRICE = round(max(bid - 0.002, 0.001), 4)
