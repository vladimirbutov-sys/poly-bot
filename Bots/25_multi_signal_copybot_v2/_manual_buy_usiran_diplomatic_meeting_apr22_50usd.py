"""Manual buy: $50 YES on US x Iran diplomatic meeting by April 22 @ best ask."""
...
TOKEN = "50740610408998204196749871302714482538726256929776684989295165941286472759432"  # YES
TITLE = "US x Iran diplomatic meeting by April 22, 2026?"
SLUG  = "us-x-iran-diplomatic-meeting-by-april-22-2026-321-831"
...
if matched > 0.5:
    ...
    data.setdefault('positions', {})[new_key] = {
        ...
        "_adopted_from": "manual_buy_2026-04-20_usiran_diplomatic_meeting_apr22_50usd",
    }
    tracker.save(data)
