# Daily Strategy Review — 2026-04-09 13:51 UTC

## ALERTS
- CRITICAL: 7-day loss rate 1.31% (4 losses / 305 bets)

## WARNINGS
- 12 positions > 72h ($152.90 frozen)
...
|--------|-------|
| Balance | $1225.30 |
| Open positions | 17 ($227.93 frozen) |
| Selling | 24 ($164.35) |
| Capital (total) | $1617.58 |
| Utilization | 24% |
| Realized PnL | $+37.81 |
| Unrealized PnL | $+2.96 |
...
### Stuck Positions (>72h)
- Will Juliana Stratton win the Illinois Democratic Senate Pri | 529h | $4.96 | neg=True
- Will Alex Vanopslagh be the next prime minister of | 530h | $4.95 | neg=True
- Will Demetrio Villca win the 2026 La Paz gubernato | 530h | $0.01 | neg=True
- Will AnЕѕe Logar be the next Prime Minister of Slovenia? | 510h | $4.91 | neg=True
- Will Lars LГёkke Rasmussen be the next prime minister of Den | 510h | $4.85 | neg=True
- 1k+ container ship transits of Suez Canal in Q1 2026? | 278h | $5.01 | neg=False
- Will the Kulmiye Party (Peace, Unity, and Development Party) | 270h | $3.28 | neg=True
- Will Russia enter Pokrovskoe by April 30, 2026? | 247h | $4.83 | neg=False
- US x Iran ceasefire by April 7? | 110h | $15.00 | neg=False
- Will Punjab FC win on 2026-04-04? | 102h | $10.01 | neg=True
- Iran x Israel/US conflict ends by April 7? | 96h | $75.03 | neg=False
- Will Cuiabá EC win on 2026-04-06? | 73h | $20.06 | neg=True
...
- **Current**: 20.0
- **Recommended**: 25
- **Reasoning**: Capital $1618 with 57 reg slots. Target 50 slots for diversification -> $25/bet.
- **Assumption**: Capital stays near current level; resolve time stable
- **Risk**: If capital drops, fewer bets = less diversification
- **Pros**: Better profit per bet
- **Cons**: Less diversification

### 2. MAX_END_DATE_REGULAR
- **Current**: 3
- **Recommended**: 3
...
### 4. MAX_NEG_RISK_FROZEN
- **Current**: 350
- **Recommended**: 100
- **Reasoning**: Neg_risk resolves 19.1h (vs reg 2.2h). Efficiency ratio 0.11. Currently $83 frozen in 10 neg positions.
